...
<html>
    ...
    <body> 
            ...
            if (rrequest.equals("checkbook")) {
                if (g.date.Date1(date1).compareTo(new java.sql.Date(System.currentTimeMillis())) < 0) {
                    ...
                    try {
                        ...
                        i = ps2.executeUpdate();
                        if (i > 0) {
                            out.println("<h1><font color=green>Request for checkbook done</font></h1>");
        %>
        ...
        <%
            ...
            out.println("<h3><font color=red>You can request for checkbook at"+" "+date2+"</font></h3>");%>
        <jsp:include page="feature.jsp"></jsp:include>
        <%
            }
        } else {
