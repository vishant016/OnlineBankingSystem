                ...
                <div class="container">
                    <div class="t-op row">
                        ...
                        <div class="col-sm-6 top-left">
                            <ul>
                                <li><i class="fas fa-phone"></i>+917041295305</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav text-center  ml-lg-auto">
                            ...
                            <li class="nav-item  mr-3">
                                <a class="nav-link" href="create.html#id01">Registeration</a>
                            </li>
                            <%
                                }
                            %>
                            ...
                            <li class="nav-item  mr-3">
                                <a class="nav-link" href="transfer.jsp#id01">Transfer</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="login.jsp#id01" style="float:right">Login</a>
                            </li>
                            <%
                                }
                            %>
                            ...
                            %>
                            <li class="nav-item">
                                <a class="nav-link" href="logout.jsp#id01" style="float:right">User Logout</a>
                            </li>
                            <%
                                }
                            ...
                            <%if (session.getAttribute("admin") == null && session.getAttribute("name") == null) {
                            %>
                            <li class="nav-item">
                                <a class="nav-link" href="adminv.jsp" style="float:right">Admin</a>
                            </li>
                            <%
                                }
                            %>
                            ...
                            %>
                            <li class="nav-item">
                                <a class="nav-link" href="adminlogout.jsp" style="float:right">AdminLogout</a>
                            </li>
                            <%
                                }
                            %>
